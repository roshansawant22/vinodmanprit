...
jQuery(document).ready(function($) {
	...
	function init() {
        var myLatlng = new google.maps.LatLng(20.273335, 75.130815);
        var maptooltipbold = 'Late Kashinarao P. Jadhav Primary School';
		var maptooltip = 'Kannad, Dist. Aurangabad';
		//---------------------------------------------------------//
		var mapOptions = {
			zoom: 17,
			scrollwheel: false,
