...
jQuery(document).ready(function ($) {
	...
	function init() {
		var myLatlng = new google.maps.LatLng(19.3812972, 72.8199725);
		var maptooltipbold = 'Kalpataru Ground, 60 Feet Road, Opp Kalimata Mandir';
		var maptooltip = 'D G Nagar, Vasai Road (W)';
		//---------------------------------------------------------//
		var mapOptions = {
			zoom: 17,
			scrollwheel: false,
...
jQuery(document).ready(function ($) {
	...
	$('.video-background').videobackground({
		videoSource: [
			['img/video/wed-vid.mp4', 'video/mp4']
		],
...
jQuery(document).ready(function ($) {
	...
	$('.video-background').videobackground({
		videoSource: [
			['img/video/wedding_audio_vid.mp4', 'video/mp4']
		],
...
//	"&copy;  " + new Date().getFullYear() + " <a href='#'>Spartans</a>. All rights reserved.";
//});
